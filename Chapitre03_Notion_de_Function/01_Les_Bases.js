...
const myDefaultParamsFunction = function (i, j = 5) {
	//j'ai déjà initialisé mon deuxième paramètre avec une valeur par defaut.
	const produit = i * j;
	return produit;
};
...
console.log(result); // ce qui fait 100 - 2 - 40 = 58
